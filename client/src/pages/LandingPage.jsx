...
const LandingPage = () => {
    ...
    return (
        <section className="relative min-h-screen flex flex-col items-center px-6 bg-gradient-to-br from-black via-[#05010e] to-black overflow-hidden">
            ...
            <footer className="absolute bottom-4 text-sm text-gray-600 font-medium">
